...
আপনার পেস্ট করা স্ক্রিপ্টটা হুবহু পোর্ট করে (pivothigh(high,1,3) → ব্যান্ড `[ph−5, ph]`,
ব্যান্ডে ঢুকলেই বক্স খোলে, close ভিতরে থাকা পর্যন্ত টানে, বাইরে গেলে লক) তিনটা প্রশ্নের
উত্তর বের করা হয়েছে — **win rate একা নয়, ট্রেড সংখ্যা আর net একসাথে**।
...
| বক্স সহ (আপনার সেটিংস) | **110** | **63.6%** | **+$137.05** (10 oz: +$1,370.53) |
...
**৩) বক্সের দাম:** ৪ বছরে **৫২,১১১ → ১৩,৪৬৪ ট্রেড (৭৪% উধাও)**। ব্লক করা ট্রেডগুলোর
win ৩০.০% (মোট −$8,625), রাখা ট্রেড ৩৭.৯% (−$2,524) — ফিল্টার খারাপ ট্রেড চেনে, কিন্তু
সংখ্যাটা মুছে দেয়।
...
| | ৪ বছর ট্রেড (kept) | win% | 4y net | Sep-26 ট্রেড | win% | net |
|---|---|---|---|---|---|---|
| বক্স ছাড়া | 52,111 (100%) | 32.5% | −$11,149 | 255 | 53.3% | +$72.60 |
| শুধু ব্লক | 13,464 (26%) | 35.6% | −$3,173 | 110 | 63.6% | +$137.05 |
| **DEFER (box_end)** | 16,649 (32%) | 34.0% | −$3,614 | **206 (81%)** | **65.5%** | **+$174.17** |

ব্যান্ড $3–$12 × fail 2–4 — সব সেটিংসেই Sep-26 net বেসলাইনের চেয়ে ভালো (+$37…+$174),
৪ বছর −$3,410…−$3,906 (বেসলাইন −$11,149)। ATR-স্কেল ব্যান্ড কাজ করে না; একদিক ব্লকও খারাপ।

**সৎ কথা:** ডিফার করলেও লম্বা উইন্ডোতে ট্রেড ~১/৩ হয়ে যায় (এক পজিশনে দুটো ট্রেড ধরে রাখা
যায় না), আর চার বছরে সব ভ্যারিয়েন্ট এখনও নেট ঋণাত্মক — ফিল্টার লস কমায়, এজ দেয় না।
